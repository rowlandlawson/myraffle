...
export const requestWithdrawal = async (_req: Request, res: Response) => {
  res.status(400).json({
    success: false,
    message:
      'Direct cash withdrawals are not supported. Store credits in your wallet are non-withdrawable and can be used to participate in raffles and purchase tickets on the platform.',
  });
};
