    ...
    htmlContent: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background-color: #f3f4f6; padding: 20px; border-radius: 8px; text-align: center; margin: 30px 0;">
            <p style="color: #4b5563; margin-bottom: 10px; font-weight: bold;">Your Verification Code:</p>
            <h1 style="color: #7c3aed; margin: 0; letter-spacing: 5px; font-size: 32px;">${verificationCode}</h1>
        </div>
        ...
        <p style="color: #6b7280; font-size: 14px;">
          This code and link expire in 24 hours. If you didn't create an account, you can safely ignore this email.
        </p>
