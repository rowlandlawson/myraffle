    ...
    <section className="bg-gradient-to-br from-slate-50 to-white py-20 px-4">
      <div className="max-w-7xl mx-auto text-center">
        <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
          Win Amazing Prizes, <span className="text-red-600">Guaranteed Fair</span>
        </h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
          Join thousands of winners. Buy raffle tickets, complete tasks to earn points, and win big
          prizes with RaffleHub.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto">
          <div className="bg-white p-4 rounded-lg shadow">
            <div className="text-2xl sm:text-3xl font-bold text-red-600">2,500+</div>
          ...
          <div className="bg-white p-4 rounded-lg shadow">
            <div className="text-2xl sm:text-3xl font-bold text-red-600">₦500M+</div>
