...
export default function RaffleCard({ item, isAuthenticated, onViewDetails }: RaffleCardProps) {
    ...
    return (
        <div
            className="group bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl hover:border-red-100 transition-all duration-300 overflow-hidden hover:-translate-y-1 cursor-pointer"
            onClick={handleClick}
        >
            {/* Image */}
