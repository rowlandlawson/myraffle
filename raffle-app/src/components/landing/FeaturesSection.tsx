...
const features = [
  {
    ...
    description:
      'All raffles are provably fair, transparent, and regulated. Every draw is fully auditable.',
    iconBg: 'bg-[#E10600]',
  ...
  },
  {
    ...
    description:
      'Complete simple daily tasks to earn cash rewards credited straight to your wallet.',
    iconBg: 'bg-amber-500',
  ...
  },
  {
    ...
    description:
      'Win high-value luxury prizes with guaranteed limited entries. Better odds than the lottery.',
