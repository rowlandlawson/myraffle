            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-400 mt-0.5">Real people, real prizes — verified draws</p>
                    </div>
                </div>
                        ...
                        {scrollWinners.map((winner, i) => (
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <div className={`w-9 h-9 ${avatarColors[i % avatarColors.length]} rounded-full flex items-center justify-center flex-shrink-0 shadow-sm`}>
